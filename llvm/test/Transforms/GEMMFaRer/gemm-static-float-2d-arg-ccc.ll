...
; RUN: opt -passes='gemm-replacer-pass,loop-deletion,dce,simplify-cfg,loop-deletion,dce,simplify-cfg' --gemmfarer-replacement-mode=matrix-intrinsics -S < %s | FileCheck %s
