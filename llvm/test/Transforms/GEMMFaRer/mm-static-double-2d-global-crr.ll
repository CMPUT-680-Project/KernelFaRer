...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f64(<128 x double> [[TMP4]], double* align 8 getelementptr inbounds ([16 x [8 x double]], [16 x [8 x double]]* @C, i32 0, i32 0, i32 0), i64 8, i1 false, i32 8, i32 16)
; CHECK-NEXT:    ret void
;
entry:
