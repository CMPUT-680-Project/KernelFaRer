...
; CHECK-NEXT:    call void @llvm.matrix.column.major.store.v128f32(<128 x float> [[TMP3]], float* align 4 getelementptr inbounds ([8 x [16 x float]], [8 x [16 x float]]* @C, i32 0, i32 0, i32 0), i64 16, i1 false, i32 16, i32 8)
; CHECK-NEXT:    ret void
;
entry:
